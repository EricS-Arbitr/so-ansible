...
| 4 | **Updates via ansible-hosted local mirror** | ansible controller runs nginx on :80 serving the SO 2.4.141 ISO (and later, package/signature mirror). SO hosts pull from `http://10.255.240.157/so-iso/`. No internet egress needed. |
